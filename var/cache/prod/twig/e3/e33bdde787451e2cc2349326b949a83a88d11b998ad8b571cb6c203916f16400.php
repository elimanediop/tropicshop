...
($context["id"] ?? null)]);
    ...
    public function block_form_rows($context, array $blocks = [])
    {
        ...
        // line 443
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_array_filter(($context["form"] ?? null), function ($__child__) use ($context, $macros) { $context["child"] = $__child__; return  !twig_get_attribute($this->env, $this->source, $context["child"], "rendered", [], "any", false, false, false, 443); }));
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            // line 444
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($context["child"], 'row');
        }
...
$context["attrvalue"] === false)) {
    ...
    {
        return new Source("", "form_div_layout.html.twig", "C:\\Users\\user\\Desktop\\projet tropicshop\\codes sources\\version_1\\tropicshop\\vendor\\symfony\\twig-bridge\\Resources\\views\\Form\\form_div_layout.html.twig");
    }
}
