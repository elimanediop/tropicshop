 ...
 */
final class Version20200707200901 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27B092A811 FOREIGN KEY (store_id) REFERENCES user (id)');
